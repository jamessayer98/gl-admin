...
export default function EditableText({ label, value, valuePrefix, onSave, ...props }) {
  ...
  const text = () => {
    ...
    if (valuePrefix) {
      inputProps.startAdornment = <InputAdornment position="start">{valuePrefix}</InputAdornment>
    }
